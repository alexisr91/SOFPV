 ...
 */
final class Version20221021142615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_EE8B1164A76ED395 ON drone');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EE8B1164A76ED395 ON drone (user_id)');
    }
}
